---
Topic: Writing a good CLAUDE.md | HumanLayer Blog
Date: 2025-12-19 Fri
References: https://www.humanlayer.dev/blog/writing-a-good-claude-md
Author: 
Aliases:
...
```
<pre><code><span>agent_docs/
</span>  |- building_the_project.md
<!-- -->  |- running_tests.md
<!-- -->  |- code_conventions.md
<!-- -->  |- service_architecture.md
<!-- -->  |- database_schema.md
<!-- -->  |- service_communication_patterns.md</code></pre>
```
