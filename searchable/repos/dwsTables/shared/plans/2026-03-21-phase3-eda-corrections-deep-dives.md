...
#### Automated Verification:
- [x] Notebook runs top-to-bottom: `jupyter nbconvert --execute notebooks/04_deep_dives.ipynb`
- [x] `eda/deep_dives.json` exists and contains all 6 finding sections
- [x] `eda/deep_dives.md` exists and is non-empty
- [x] `eda/deep_dives.png` visualization is generated
- [x] Labor cost match rate is >95% (timesheet entries matched to pay rates) — actual: 99.5%
- [x] True margin projects count is 700+ (not 21) — actual: 813
